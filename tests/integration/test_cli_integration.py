...
class TestCLIIntegration:
    ...
    def test_cli_migrate_command(self, temp_config_file):
        ...
        with patch('llama_prompt_ops.interfaces.cli.PromptMigrator', return_value=mock_migrator), \
             patch('llama_prompt_ops.interfaces.cli.get_dataset_adapter_from_config', return_value=mock_dataset_adapter), \
             patch('llama_prompt_ops.interfaces.cli.get_models_from_config', return_value=(None, None)), \
             patch('llama_prompt_ops.interfaces.cli.get_metric', return_value=MagicMock()), \
             patch('llama_prompt_ops.interfaces.cli.get_strategy', return_value=MagicMock()), \
