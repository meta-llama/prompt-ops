...
export const OptimizationResults: React.FC<OptimizationResultsProps> = ({
  ...
  return (
    <div className="bg-white/90 backdrop-blur-xl rounded-2xl p-8 shadow-xl border border-facebook-border">
      ...
      {/* Content container */}
      <div className="border border-facebook-border bg-white/60 backdrop-blur-sm rounded-xl p-6 mb-8 max-h-[400px] overflow-y-auto">
        <div className="whitespace-pre-wrap text-facebook-text text-lg leading-relaxed">
          {activeTab === 'before' ? originalPrompt : optimizedPrompt}
        </div>
      </div>
